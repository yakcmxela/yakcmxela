...
function get_mah_scripts() {
	...
	wp_register_script('three-js', get_template_directory_uri() . '/js/three.min.js', array('jquery'), true);	
	wp_register_script('tween-js', 'https://cdnjs.cloudflare.com/ajax/libs/tween.js/16.3.5/Tween.min.js', true);
